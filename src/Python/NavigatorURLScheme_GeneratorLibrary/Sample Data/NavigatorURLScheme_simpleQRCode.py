...
from src.Python.NavigatorURLScheme_GeneratorLibrary.NavigatorURLScheme import NavigatorURLScheme, NavigatorURLHyperlinks, NavigatorURLQRCode
...
NavigatorURLQRCode().returnQRCodeText(navigatorURL)
NavigatorURLQRCode().saveQRCodeSVG(navigatorURL, title)
NavigatorURLQRCode().saveQRCodePNG(navigatorURL, title)
